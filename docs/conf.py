...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('..', 'civicpy')))
...
man_pages = [
    (master_doc, 'civicpy', 'civicpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'civicpy', 'civicpy Documentation',
     author, 'civicpy', 'One line description of project.',
     'Miscellaneous'),
]
